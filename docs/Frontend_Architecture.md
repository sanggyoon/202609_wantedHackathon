...
> **2026-09-19 변경:** 고소장·답변 저장 API 연결과 로컬 DB 검증까지 끝났다(2026-09-17).
> 대화 화면을 채팅 형태로 개편하고, 공유 항목 선택 단계를 없앴으며, 감정 이미지 왜곡과
> 도입문 생성을 붙였다(2026-09-18~19). 최신 범위는
> [사건 링크 연결](./Case_Link_Integration.md)을 따른다.

> 2026-09-16 변경: 홈에서 사건 생성, /case/[token] 조회, 작성 권한 보관, 만료·오류 화면 연결.

> 2026-09-14 변경: A/B 진술과 양측 중재 요약에 실제 API를 연결했다. 최신 구조와 실행 방법은
> [A 대화 엔진 연결](./A_Conversation_Integration.md)과 [B 흐름 연결](./B_Respondent_Integration.md)을 따른다.

> 버전: 0.2 · 작성일: 2026-09-10 · 최종 수정: 2026-09-19
> 상태: 프론트엔드 설계 기준 / 남은 미정 정책은 §13
